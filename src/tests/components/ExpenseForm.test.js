...
// should set amoount if valid input e.g. 23.50
test('should set amoount if valid input', () => {
    const value = '24.50';
    const wrapper = shallow(<ExpenseForm />);
...
// should not set amount if invalid input eg. 12.122
test('should not set amoount if invalid input', () => {
    const value = '12.122';
    const wrapper = shallow(<ExpenseForm />);
    wrapper.find('input').at(1).simulate('change', {
        target: { value }
